...
import tun.proxy.dns.DnsPacket;
import tun.proxy.dns.Question;
import tun.proxy.dns.Resource;
import tun.proxy.dns.ResourcePointer;
        ...
        try {
            ...
            while (m_Client != null && !m_Client.isClosed()) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Log.e("Dnsproxy Parse dns error",e.toString());
