...
//                LocalVpnService.Instance.writeLog("Error: connect to %s failed.", m_ServerEP);
                Log.i("Error: connect",String.format("Error: connect to %s failed.", m_ServerEP));
                this.dispose();
            }
        } catch (Exception e) {
//            LocalVpnService.Instance.writeLog("Error: connect to %s failed: %s", m_ServerEP, e);
            Log.i("Error: connect",String.format("Error: connect to %s failed:%s", m_ServerEP,e));
            this.dispose();
        }
    }
